...
ActiveRecord::Schema.define(version: 2021_12_29_205156) do
  ...
  create_table "requests", force: :cascade do |t|
    ...
    t.index ["requestoption_id"], name: "index_requests_on_requestoption_id"
